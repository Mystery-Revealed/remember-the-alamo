...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'remember-the-alamo', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[remember-the-alamo] listening on :${config.port} — sessions live in memory only`);
});
